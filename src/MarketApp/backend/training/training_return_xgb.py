...
def train_return_xgb(
    ...
    print(
        "\nReturn XGBoost training completed successfully."
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--out",
        default="models/return_xgb_model.pkl",
    )
