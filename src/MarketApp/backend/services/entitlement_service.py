    ...
    def _parse_datetime(value: Any) -> datetime | None:
        ...
        if "." in raw:
            ...
            if timezone_index is None:
                ...
                timezone_part = tail[timezone_index:]
            ...
            raw = f"{head}.{fraction}{timezone_part}"
